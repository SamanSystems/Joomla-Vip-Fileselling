...
function set_local_text($language_id)
{
	...
	*/
	...
	$text = array(
	'index_of' => array('فهرست فایل ها', 'Index de', 'Index der','Índice de'),
	
	'key' => array('کلید', 'Clé','Schlüssel','Llave'),
	
	'folder' => array('پوشه', 'Dossier','Ordner','Carpeta'),
	
	'file' => array('فایل','Fichier','Datei','Archivo'),
	
	'switch_to_list' => array('نمایش به صورت فهرست', 'Passez à vue de liste','Umschalten auf Listenansicht','Cambiar a vista de lista'),
	
	'switch_to_thumbnail' => array('نمایش ویژه','Switch to vignette','Umschalten auf Symboldarstellung ','Cambiar a vista de miniaturas'),
	
	'launch_gallery' => array('گالری', 'Lancer la galerie','Start Galerie','Lanzamiento de la galería'),
	
	'launch_media_player' => array('پلیر', 'Lancement media player','Starten Sie Media Player ','Lanzamiento Media Player'),
	
	'show_hide_stats' => array('نمایش و یا مخفی سازی آمار','Afficher/cacher les statistiques','Zeigen/verstecken Statistiken','Mostrar/ocultar las estadísticas'),
	
	'name' => array('نام', 'Nom','Name','Nombre'),
	
	'size' => array('اندازه','Taille','Größe','Tamaño'),
	
	'date_uploaded' => array('تاریخ آپلود','Date Uploaded','Date Uploaded','Fecha de la subida'),
	...
	'this_page_loaded_in' => array('این صفحه در ','Cette page chargée dans','Diese Seite wurde geladen in','Cargado en esta página'),
	
	'seconds' => array(' ثانیه بارگذاری شده است','secondes','sekunden','segundo'),
	...
	'total_folders' => array('مجموع پوشه ها','Total dossiers','Insgesamt Ordner','Total de carpetas'),
	
	'total_files' => array('مجموع فایل ها','Total fichiers','Gesamt-Dateien','Total de archivos '),
	
	'total_files_and_folders' => array('ترکیبی','Combiné','Kombinierte','Combinada'),
	
	'consuming' => array('حجم تقریبی', 'consommation','konsum','consumir'),
